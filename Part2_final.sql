...
--	Nearly every patient is LS99 postcode
...
CREATE INDEX IX_registration_guid ON #WeightShortList (registration_guid)
...
--	Inclusions are handled in the final output
...
--	This will produce zero rows as the medication checks returned zero.
...
WHERE		p.patient_id NOT IN (
				SELECT e.patient_id from #Exclusions e )--